...
### Git提交信息
```
Commit: c412d488f368ed7861a02ce7ee61f1ec91892d16
Message: Refactor RestClient configuration and add explicit content type headers
Date: 2026-07-21
Branch: master
```

### 测试覆盖的代码范围
本测试报告基于上述commit的代码进行测试和验证。
