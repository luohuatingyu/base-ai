...
Commit: bf07c70a41f65fc75d763c4c614bff508a2ad979
- 提交说明: Localize workflow node metadata
- 测试日期: 2026-08-12
- 分支: master
...
- 回滚功能提交 `bf07c70` 后重新执行 `docker compose up --build -d`；V19/V20 为向后兼容的新增列，不应修改已应用的 Flyway 历史或直接删除列。
