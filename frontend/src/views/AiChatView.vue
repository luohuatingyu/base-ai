  ...
  <div class="panel chat-panel">
    ...
    <el-tabs v-model="activeTab" class="chat-tabs">
      ...
      <div v-for="image in pendingImages" :key="image.name + image.dataUrl" class="pending-image">
        ...
        <el-input v-model="prompt" class="chat-question-input" type="textarea" :rows="4" resize="none" :placeholder="t('chat.placeholder')" @keydown.meta.enter="send" @keydown.ctrl.enter="send" />
      ...
      <el-tab-pane :label="t('chat.promptTab')" name="prompt">
        <div class="prompt-settings">
          ...
          <el-input v-model="systemPrompt" class="prompt-input" type="textarea" :rows="12" resize="none" :placeholder="t('chat.promptPlaceholder')" />
