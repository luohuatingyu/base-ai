...
<template>
  <div class="panel">
    ...
    <el-table :data="rows" table-layout="auto">
      <el-table-column prop="name" :label="t('common.name')" min-width="180"/><el-table-column prop="httpMethod" :label="t('common.method')" width="90"/><el-table-column prop="url" label="URL" min-width="320" show-overflow-tooltip/>
      <el-table-column prop="cronExpression" label="Cron" min-width="180"><template #default="s">{{s.row.cronExpression||t('apiTrigger.manualOnly')}}</template></el-table-column>
      ...
      <el-table-column prop="lastStatus" :label="t('apiTrigger.latestResult')" width="130"/><el-table-column :label="t('common.operation')" width="380" fixed="right"><template #default="s">
