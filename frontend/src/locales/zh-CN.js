export default {
  ...
  models: { title: '模型配置', description: '维护供应商下的模型标识、能力和思考等级映射。', add: '新增模型', edit: '编辑模型', provider: '供应商', identifier: '模型标识', modelType: '模型类型', capability: '能力', text: '文本', vision: '视觉', low: '低', middle: '中', high: '高', thinkingLevels: '思考等级映射', thinkingPlaceholder: '例如 EXTRA_HIGH=xhigh, LOW=low', test: '测试', connected: '连接成功，耗时 {duration}ms' },
