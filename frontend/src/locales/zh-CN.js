export default {
  ...
  routes: { title: '能力路由', description: '按供应商池、能力和思考等级筛选模型。', add: '新增路由', edit: '编辑路由', featureCode: '功能编码', candidates: '候选模型', providerPool: '供应商池', thinking: '思考模式', thinkingLevel: '思考等级', example: '例如 chat' },
