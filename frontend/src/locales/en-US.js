export default {
  ...
  providers: { title: 'Model Providers', description: 'API keys are encrypted and only masked values are listed.', add: 'Add Provider', edit: 'Edit Provider', viewKeys: 'View keys', baseUrl: 'Service URL', concurrencyLevel: 'Concurrency Scope', concurrency: 'Concurrency', timeout: 'Timeout (seconds)', provider: 'Provider', apiKeys: 'API Keys', keepKeys: 'Leave blank to keep keys; separate multiple keys with commas or new lines', multipleKeys: 'Separate multiple keys with commas or new lines' },
