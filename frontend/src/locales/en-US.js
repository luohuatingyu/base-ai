export default {
  ...
  routes: { title: 'Capability Routes', description: 'Filter models by provider pool, capability, and thinking level.', add: 'Add Route', edit: 'Edit Route', featureCode: 'Feature Code', candidates: 'Candidate Models', providerPool: 'Provider pool', thinking: 'Thinking Mode', thinkingLevel: 'Thinking level', example: 'e.g. chat' },
