export default {
  ...
  apiTriggerSecurity: { title: 'API Trigger Security', description: 'Dynamically control accessible hosts and private networks. Changes take effect without restarting services.', defaultPolicy: 'Before any configuration is saved, only localhost, 127.0.0.1, and ::1 loopback addresses are allowed.', allowedHosts: 'Allowed Hosts', allowedHostsPlaceholder: 'localhost\n127.0.0.1\n::1\n*.example.com', allowedHostsHelp: 'Enter one rule per line or separate with commas. Exact hosts, *.example.com, and * are supported. An empty list denies all hosts.', allowPrivateNetwork: 'Allow Private Networks', allowPrivateNetworkHelp: 'When disabled, loopback, link-local, private, and multicast addresses are rejected. This switch remains independent from *.', wildcardWarning: '* allows any host. Review the private network switch carefully.', fullAccessConfirm: 'This configuration allows any host and private network address. Save it?', riskTitle: 'High-risk Configuration' },
