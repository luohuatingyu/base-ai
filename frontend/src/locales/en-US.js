export default {
  ...
  apiTriggerSecurity: { title: 'API Trigger Security', description: 'Dynamically control accessible hosts, loopback addresses, and private networks. Changes take effect without restarting services.', defaultPolicy: 'localhost, 127.0.0.1, and ::1 are allowed by default without host rules. Other private networks are disabled by default.', allowedHosts: 'Additional Allowed Hosts', allowedHostsPlaceholder: 'api.example.com\n*.trusted.example.com', allowedHostsHelp: 'Only enter additional non-loopback rules. Exact hosts, *.example.com, and * are supported. An empty list allows no additional hosts.', allowLoopback: 'Allow Loopback Addresses', allowLoopbackHelp: 'Controls localhost, 127.0.0.1, ::1, and allowed hosts that resolve to loopback addresses. Disabling it still blocks loopback when * is configured.', allowPrivateNetwork: 'Allow Other Private Networks', allowPrivateNetworkHelp: 'Controls link-local, private, IPv6 ULA, and multicast addresses, excluding loopback. This switch remains independent from *.', wildcardWarning: '* allows any host but does not bypass the loopback or private network switches.', fullAccessConfirm: 'This configuration allows any host, loopback address, and other private network. Save it?', riskTitle: 'High-risk Configuration' },
