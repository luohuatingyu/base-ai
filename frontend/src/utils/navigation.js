const menuKeysByPermission = Object.freeze({
  ...
  'data-sync:list': 'nav.items.dataSync',
  'data-sync:create': 'dataSync.title',
  'data-sync:update': 'common.edit',
  'data-sync:delete': 'common.delete',
  'data-sync:preview': 'dataSync.preview',
  'data-sync:run': 'dataSync.run',
  'data-sync:cancel': 'dataSync.cancel',
  'data-sync:logs': 'dataSync.title',
  'server:list': 'nav.items.servers',
  'server:create': 'servers.add',
  'server:update': 'servers.edit',
  'server:delete': 'common.delete',
  'server:test': 'servers.test',
  'server:deploy': 'servers.deploy',
  'server:rollback': 'servers.deploy',
  'server:logs': 'servers.title',
  ...
  'knowledge:base:list': 'nav.items.knowledgeBases',
  'knowledge:base:create': 'knowledgeBases.add',
  'knowledge:base:update': 'common.edit',
  'knowledge:base:delete': 'common.delete',
