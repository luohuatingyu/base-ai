...
:deep(.vue-flow__handle) { width: 6px; height: 6px; min-width: 6px; min-height: 6px; border: 0; border-radius: 50%; background: transparent; }
:deep(.vue-flow__handle::before) { position: absolute; top: 50%; left: 50%; width: 40px; height: 40px; border-radius: 50%; background: transparent; content: ''; pointer-events: auto; transform: translate(-50%, -50%); }
