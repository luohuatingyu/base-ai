...
public class GlobalExceptionHandler {
    ...
    /** 将协作取消映射为冲突响应。 */ @ExceptionHandler(TraceCancelledException.class) public ResponseEntity<ApiResponse<Void>> cancelled(TraceCancelledException exception){return ResponseEntity.status(409).body(ApiResponse.failure("TRACE_CANCELLED",exception.getMessage()));}
