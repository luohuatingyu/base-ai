...
public class DataSyncController {
    ...
    /** 查询同步计划。 */
    @GetMapping("/plans")
    @RequiredPermission("data-sync:list")
    ...
    @RequiredPermission("data-sync:delete")
    public void delete(@PathVariable Long id) { service.delete(id); }

    /** 查询数据库表元数据。 */
    @GetMapping("/connections/{connectionId}/tables")
    @RequiredPermission("data-sync:preview")
