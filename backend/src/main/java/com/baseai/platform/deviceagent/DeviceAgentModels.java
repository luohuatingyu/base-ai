...
/** 通用只读 iOS 设备 Agent 协议模型。 */
public final class DeviceAgentModels {
    public static final Set<String> VALID_FEATURES = Set.of("READ_ONLY_DIAGNOSTICS", "AUTOSTART");
    ...
    public record AgentRegistrationView(Long id, String agentId, String deviceName, String pairingStatus,
                                        ...
                                        String lastHeartbeatStatus, String featureDiagnostics,
    ...
    /** 管理端更新只读诊断和自启动开关。 */
    public record UpdateFeaturesRequest(String featureDiagnostics, String featureAutostart) {}
    /** 管理端撤销 Agent 请求。 */
    ...
    public record AgentConfigView(String agentId, String pairingStatus, String featureDiagnostics,
                                  String featureAutostart, Instant lastOnlineAt) {}
    /** 管理端创建主机级只读或维护命令。 */
    public record CreateCommandRequest(String agentId, String commandType, Object commandParams) {}
    /** Agent 命令完整视图。 */
    public record AgentCommandView(Long id, String agentId, String commandType, Object commandParams,
    ...
    /** Agent 领取的短期命令租约。 */
    public record LeaseCommandResponse(Long commandId, String commandType, Object commandParams,
    ...
    public record AgentHealthRequest(String status, String agentVersion, String iosVersion,
                                     String lastErrorCode, List<String> availableVersions) {}
    /** 单项只读诊断结果。 */
